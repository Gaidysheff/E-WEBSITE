...
const CartItem = () => {
  return (
    <div
      className="flex items-center justify-between gap-6 lg:gap-4 xl:gap-6 
    ...
    >
      ...
      {/* Line-2 */}
      <div className="flex items-center gap-2 xsm:gap-6 mx-auto">
        {/* Quantity Selector */}
        <div
        ...
        <button
          ...
          transition text-red-500 border border-red-300"
        >
      ...
      {/* Update Cart Button */}
      <Button className="update-item-btn mx-auto">Update Cart</Button>
    </div>
  );
};
